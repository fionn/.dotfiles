...
if hash mmdbinspect 2> /dev/null && [[ -f ~/.cache/mmdb/GeoIP2-Anonymous-IP.mmdb ]] && [[ -f ~/.cache/mmdb/GeoIP2-City.mmdb ]]; then
    alias mmdb="mmdbinspect --db ~/.cache/mmdb/GeoIP2-Anonymous-IP.mmdb --db ~/.cache/mmdb/GeoIP2-City.mmdb"
fi

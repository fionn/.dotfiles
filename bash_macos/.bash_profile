...
# shellcheck source=/dev/null
[ -f $BASH_COMPLETION_COMPAT_DIR/brew-services ] && . $BASH_COMPLETION_COMPAT_DIR/brew-services
...
if [ -f $BASH_COMPLETION_COMPAT_DIR/git-prompt.sh ]; then
    # shellcheck source=/dev/null
    source $BASH_COMPLETION_COMPAT_DIR/git-prompt.sh
